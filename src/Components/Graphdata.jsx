...
export default function Graphdata() {
    ...
    return (<>
        ...
        <div className='flex justify-around bg-white p-2 rounded-lg shadow-xl relative'>
            ...
            <div className='flex flex-col p-2  border-[1.5px] rounded-md justify-between my-2'>
                <div className='font-medium text-[14px] pl-1 pt-1 text-[#667085]'>NIFTY</div>
                <div className='flex  items-start '>
                    <div className='flex flex-col items-center'>
                        <div className='font-semibold text-[22px] mt-2 text-[#1D2939]'>17,070.50</div>
            ...
            <div className='flex flex-col p-2  border-[1.5px] rounded-md justify-between my-2'>
                <div className='font-medium text-[14px] pl-1 pt-1 text-[#667085]'>BANK NIFTY</div>
                <div className='flex  items-start '>
                    <div className='flex flex-col items-center'>
                        <div className='font-semibold text-[22px] mt-2 text-[#1D2939]'>39.894.50</div>
            ...
            <div className='flex flex-col p-2 border-[1.5px] rounded-md justify-between my-2'>
                <div className='font-medium text-[14px] pl-1 pt-1 text-[#667085]'>SENSEX</div>
                <div className='flex  items-start '>
                    <div className='flex flex-col items-center'>
                        <div className='font-semibold text-[22px] mt-2 text-[#1D2939]'>58074.65</div>
                        <div className='bg-[#ECFDF3] flex text-[12px] px-[5px] py-[3px] rounded-xl my-2'>
                            <img src={up} alt='up' className='w-[12px] pl-[1px] mr-[4px]' />
                            <p className='text-[#027A48] font-medium'>+0.66%</p>
                        </div>
            ...
            <div className='flex flex-col p-2 border-[1.5px] rounded-md justify-between my-2'>
                <div className='font-medium text-[14px] pl-1 pt-1 text-[#667085]'>NIFTY50O</div>
                <div className='flex  items-start '>
                    <div className='flex flex-col items-center'>
                        <div className='font-semibold text-[22px] mt-2 text-[#1D2939]'>15,877.40</div>
                        <div className='bg-[#FEF3F2] flex text-[12px] px-[5px] py-[3px] rounded-xl my-2'>
                            <img src={down} alt='up' className='w-[12px] pl-[1px] mr-[4px]' />
                            <p className='text-[#B42318] font-medium'>-0.66%</p>
                        </div>
